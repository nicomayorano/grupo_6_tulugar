...
userRouter.get('/:id/edit', authRequired, userController.editForm);
...
userRouter.post('/:id', multer('usersImages', { size: 2_000_000, files: 1 }), imageValidation, userController.edit);
