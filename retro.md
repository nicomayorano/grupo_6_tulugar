...
<h2 style="text-align: center">Sprint :two:</h2>
...
<h2 style="text-align: center">Sprint :three:</h2>
...
<h2 style="text-align: center">Sprint :four:</h2>
...
<h2 style="text-align: center">Sprint :six:</h2>

1.    Comenzar a hacer: Para la resolución del sprint lo primero que se hace es una reunión vía zoom en la cual tratamos los temas a resolver, se organiza el tablero de trabajo y se disponen los modos y tareas a realizar. Luego cada integrante resuelve los puntos asignados con la forma de codear que conozca. Y una vez garantizado que ese bloque de código funciona, uno de los integrantes que cuenta con mayor experiencia en el campo, se encarga de pasar ese código y funcionalidad a uno que cuente con mayor aceptación en el campo laboral actual. Creemos que puede ser productivo comenzar a dejar a modo de comentario la descripción específica de cada parte de código que no se dictó en el curso, para tener una base a la hora de necesitar reutilizar esa porción de código o trabajar con ella.

2.    Hacer más: Estar aún más pendientes de corroborar el estado del tablero de trabajo antes de ponerse a trabajar en algo puntual o de enviar alguna consulta por los distintos medios de comunicación; ya que de esta forma se ahorra en tiempos y conflictos.

3.    Continuar haciendo: Seguir con el lineamiento de forma de trabajo del tablero. Con el trabajo de cada integrante como se estableció anteriormente. Controlar dependencias. Seguir con las reuniones para organizar las tareas, consensuar ideas, evaluar cómo venimos y planificar cómo seguimos. Pautar con fecha y horario fijo las reuniones como así también los temas a tratar. Seguir conectando y preguntando al momento de surgir un conflicto, para la resolución conjunta. Sumar tareas en la sección pending cuando nos encontremos con modificaciones de trabajos anteriores, con puntos faltantes o nuevos por resolver. Actualizar el site-map. Continuar con la elección de los nombres a utilizar en inglés, simples, que sean descriptibles o que refieran a su funcionalidad. Y continuar incorporando todas las reuniones ¨extras¨ que se consideren necesarias frente a una problemática, duda o solicitud de alguno de los integrantes del grupo. 
